...
ALTER TABLE BookGenre ADD FOREIGN KEY (ISBN) REFERENCES ComicBooks(ISBN) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE BookGenre ADD FOREIGN KEY (Genre) REFERENCES Genres(Genre) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE UserCart ADD FOREIGN KEY(Email) References Users(Email) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE UserCart ADD FOREIGN KEY(ISBN) References ComicBooks(ISBN) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE BookWriter ADD FOREIGN KEY(ISBN) References ComicBooks(ISBN) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE BookWriter ADD FOREIGN KEY(WriterName) References Writers(WriterName) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE BookIllustrator ADD FOREIGN KEY(ISBN) References ComicBooks(ISBN) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE BookIllustrator ADD FOREIGN KEY(IllustratorName) References Illustrators(IllustratorName) ON DELETE CASCADE ON UPDATE CASCADE;   
ALTER TABLE Orders ADD FOREIGN KEY(CustomerEmail) REFERENCES Users(Email) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE BookOrder ADD FOREIGN KEY (ISBN) REFERENCES ComicBooks(ISBN) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE BookOrder ADD FOREIGN KEY (OrderID) REFERENCES Orders(OrderID) ON DELETE CASCADE ON UPDATE CASCADE
